...
\emph{What small actions are needed?} Authors need guidance about when to cite software (\ie which software should be cited) and how to cite software (\ie citation formats that will be picked up by citation tracking systems). 
...
\emph{What small actions are needed?} Blogging? \chg{Upfronting}{Emphasizing} the ``forgotten'' aspects in project contribution guidelines.
