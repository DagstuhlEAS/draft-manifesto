...
and
(iii) ensuring the quality and sustainability of software during \bc{qu: only during? or also possibly after (i.e. thorough the whole lifecycle, incl. how to set up / organize the maintenance, evolution...) ?} its \emph{development}:
...
Require a link to the software (screenshots are not enough!) \bc{,or the relevant citation when available}. 
%
