...
Software is growing more important in research but is typically not given due recognition\\
Explain the categories of pledges.\\
Explain how the pledges are all intended to be actionable.\\
Fill this in as the rest starts to stabilize.\\
Need to recognize software as citable.\\
Need to acknowledge formally the role of a ``research software engineer''\\
}
