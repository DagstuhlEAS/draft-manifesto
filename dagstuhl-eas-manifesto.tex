...
\on{OR: When I review scholarly works (papers, software, \etc), I will point out missing or poorly organized software citations.}
...
Furthermore, we can provide a \meh{template language} \on{obscure. is it a template? a language? a template for language? a language for templates?} and seek to have respected organizations recommend \meh{them}. \on{what does "them" refer to?}
