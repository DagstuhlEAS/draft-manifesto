...
Although the role of software is growing increasingly important in diverse fields of research, it is commonly not given its due recognition. Software is often not cited, or even considered to be citable. Developers of research software are not given due credit, and may not be invited as co-authors on papers disseminating the research that their software enabled.
...
By requiring authors to provide these links, we will work towards educating the community to produce reusable software. Or at least, a set of tests that work for the reviewers of the publication. 
...
Conference chairs/journal editors may add this requirement explicitly when when publishing a call for papers. 
